...
function saveToDb()
{
  ...
  try {
      ...
      $sql = "INSERT INTO zutat (Name, IsFish,IsMeat,IsNut,IsLactose,IsGluten,IsVegetarian,IsVegan) 
      VALUES (?,?,?,?,?,?,?,?)";
      $conn->prepare($sql)->execute([$name, $IsFish, $IsMeat,$IsNut,$IsLactose,$IsGluten,$IsVegetarian,$IsVegan]);
      $insertSuccess = true;
    }
